...
const Tenants = () => {
  ...
  const [assignLeaseModal, setAssignLeaseModal] = useState(false);
      ...
      <div>
        ...
        {assignLeaseModal && (
          <AssignLeaseModal
            ...
            tenant={activeTenant}
            isOpen={assignLeaseModal}
            onClose={() => setAssignLeaseModal(false)}
            onSuccess={() => {
              toast.success("Lease assigned successfully");
              setAssignLeaseModal(false);
            }}
            units={units}
          />
        )}
